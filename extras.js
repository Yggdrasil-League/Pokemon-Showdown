...
exports.extras = function() {
    ...
    Users.User.prototype.hasSysopAccess = function() {
        ...
        //Remember, ONLY give Sysop access to people you fully trust.
        var systemOperators = ['chmpion robo'];
    ...
    Users.User.prototype.onDisconnect = function(connection) {
        if (this.named) dates.setdate(this);
    ...
    Rooms.GlobalRoom.prototype.onRename = function(user, oldid, joining) {
        if (user.named && toId(oldid) != toId(user)) dates.setdate(user.userid);
